                            ...
                            <div class="space-y-3">
                                <div
                                    ...
                                    <div class="flex flex-col gap-3">
                                        <!-- Controles adicionales arriba para dejar el input al final -->
                                        <div class="flex items-center gap-2 sm:gap-3 justify-between sm:justify-start order-1">
                                            <!-- Toggle de -10 -->
                                            <div
                                                @click="hizoMenos10[jugador.id] = !hizoMenos10[jugador.id]; manejarMenos10(jugador.id)"
                                                class="flex-1 sm:flex-none flex items-center gap-2 px-3 py-2 rounded-xl cursor-pointer select-none transition-all duration-200"
                                        ...
                                        <!-- Input de puntos al final del bloque -->
                                        <div class="flex flex-col order-2">
                                            <label :for="`puntos-${jugador.id}`" class="block text-xs text-navy-400 mb-1">Puntos:</label>
                                            <input
                                                ...
                                                pattern="[0-9]*"
                                                :tabindex="index + 1"
                                                class="input-field text-center text-2xl font-semibold w-full tabular-nums"
                                                :class="{
