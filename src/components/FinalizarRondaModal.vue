            ...
            <form @submit.prevent="confirmar">
              <div class="space-y-4 max-h-[60vh] overflow-y-auto">
                ...
                >
                  ...
                  <div class="flex items-center gap-2">
                    ...
                    >
                      -10<br><span class="text-xs text-gray-500">(especial)</span>
                    </label>
                  </div>

                  <!-- Indicador de -10 -->
                  <div v-if="hizoMenos10[jugador.id]" class="text-2xl animate-bounce-slow">
                    ✨
                  </div>
              ...
              <div class="mt-6 bg-blue-50 border-l-4 border-blue-400 p-4">
                <p class="text-sm text-blue-800">
                  ...
                  <span class="block mt-1">El botón <strong>"🏆 Chinchón"</strong> termina la partida inmediatamente y ese jugador gana.</span>
                </p>
              </div>
